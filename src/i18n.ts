...
export const i18nData: { [locale: string]: I18nStrings } = {
  'zh_CN': {
    ...
    ctxPublishNote: '发布笔记', ctxExportPdf: '导出 PDF',
    ctxPin: '📌 收藏',
    ctxUnpin: '取消收藏',
    cancel: '取消',
  },
  'zh_TW': {
    ...
    ctxPublishNote: '發佈筆記', ctxExportPdf: '匯出 PDF',
    ctxPin: '📌 收藏',
    ctxUnpin: '取消收藏',
    cancel: '取消',
  },
  'en_US': {
    ...
    ctxPublishNote: 'Publish note', ctxExportPdf: 'Export PDF',
    ctxPin: '\uD83D\uDCCC Pin',
    ctxUnpin: 'Unpin',
    cancel: 'Cancel',
  },
  'ru': {
    ...
    ctxPublishNote: 'Опубликовать заметку', ctxExportPdf: 'Экспорт в PDF',
    ctxPin: '\uD83D\uDCCC Закрепить',
    ctxUnpin: 'Открепить',
    cancel: 'Отмена',
  },
  'ja_JP': {
    ...
    ctxPublishNote: 'ノートを公開', ctxExportPdf: 'PDF にエクスポート',
    ctxPin: '\uD83D\uDCCC ピン留め',
    ctxUnpin: 'ピン解除',
    cancel: 'キャンセル',
  },
